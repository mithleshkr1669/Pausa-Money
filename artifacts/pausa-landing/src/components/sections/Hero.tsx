  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        {/* Layout Standard: Left 40% empty/visual, Right 60% Content */}
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-6">
              ...
              Built for India's AA Ecosystem
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold text-foreground leading-[1.1] mb-6">
              ...
              <span className="text-gradient">One Transaction at a Time.</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-sans">
              We transform raw, messy bank data into a holistic health report for your money. Know your liquidity, build resilience, and optimize your financial pulse.
            </p>
