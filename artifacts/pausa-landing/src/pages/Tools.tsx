      ...
      <div className="h-full flex flex-col">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Interactive tools with live projections
          </p>
        </header>
        <div className="flex-1 flex overflow-hidden">
          <nav
            className="w-44 shrink-0 border-r border-border p-3 flex flex-col gap-1"
            style={{ background: "hsl(0 0% 7%)" }}
          >
            {TOOLS.map((t) => {
              const Icon = t.icon;
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-start gap-0.5 px-3 py-2.5 rounded-lg text-left transition-all duration-150 ${active ? "bg-primary/12 border border-primary/20 text-primary" : "hover:bg-white/4 text-muted-foreground hover:text-foreground border border-transparent"}`}
                >
