...
- [PDF extraction model](pdf-extraction.md) — Use `gemini-2.5-flash` (stable) for Gemini vision PDF/image extraction in `agents.ts`; `gemini-2.5-flash` is unstable/may require preview model ID.
